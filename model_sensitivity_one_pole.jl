...
#collect_policies("policies_sensitivity67.csv",C)
#simulate(nb_w,nb_d,H,h,pr,n,years,Q,d,P_daily01,"simulation6701.csv","policies_sensitivity67.csv","fluid",δ67,p67,"cost6701.csv",false,C)
#simulate(nb_w,nb_d,H,h,pr,n,years,Q,d,P_daily99,"simulation6799.csv","policies_sensitivity67.csv","fluid",δ67,p67,"cost6799.csv",false,C)
#simulate(nb_w,nb_d,H,h,pr,n,years,Q,d,P_daily67,"simulation6767.csv","policies_sensitivity67.csv","fluid",δ67,p67,"cost6767.csv",false,C)
...
#simulate(nb_w,nb_d,H,h,pr,n,years,Q,d,P_daily67,"simulation0167.csv","policies_sensitivity01.csv","fluid",δ01,p01,"cost0167.csv",false,C)
...
#simulate(nb_w,nb_d,H,h,pr,n,years,Q,d,P_daily67,"simulation9967.csv","policies_sensitivity99.csv","fluid",δ99,p99,"cost9967.csv",false,C)
